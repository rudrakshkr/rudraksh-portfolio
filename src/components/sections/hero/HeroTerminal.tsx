...
const SCRIPT: Line[] = [
    ...
    {
        kind: "out",
        text: "→ github.com/rudrakshkr/portfolio  main → main",
        pause: 420,
    },
    ...
    {
        kind: "out",
        text: "✓ Typescript   0 errors in 2.1s",
        pause: 480,
        sets: { typecheck: "done", tests: "run" },
    },
    {
        kind: "out",
        text: "✓ Tests        148 passed",
        pause: 520,
        sets: { tests: "done", build: "run" },
    },
    {
        kind: "out",
        text: "✓ Next.js      Production build complete",
        pause: 520,
        sets: { build: "done" },
    },
    ...
    {
        kind: "muted",
        text: "→ Uploading optimized assets...",
        pause: 420,
    },
    {
        kind: "out",
        text: "→ Publishing portfolio to Vercel",
        pause: 460,
    },
    {
        kind: "ok",
    ...
    {
        kind: "cmd",
        text: "curl -s /api/health",
    },
    {
        kind: "json",
        text: '{"status":"online","portfolio":"live","response":"84ms"}',
        pause: 300,
        api: true,
    },
]
...
export default function HeroTerminal() {
    ...
    const apiVisible = shown.some((line) => line.api)
    ...
    return (
        ...
        >
            ...
            >
                <TerminalIcon
                    className="h-3.5 w-3.5 shrink-0 text-[#8A919E]"
                    aria-hidden="true"
                />
                ...
                <span
                    ...
                    "
                >
                    rudraksh-portfolio — zsh
                </span>

                <span className="ml-auto flex shrink-0 items-center gap-1.5 rounded-full border border-white/10 px-2 py-0.5">
                    <motion.span
                ...
                {STATUS_LABELS.map((item) => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <span
                                className={`truncate font-mono text-[9px] tracking-wide transition-colors duration-300 sm:text-[9.5px] ${
                                    state === "idle"
                                        ? "text-[#343A45]"
            ...
            >
                {shown.map((line, i) => (
                    <motion.p
                        ...
                        className={`whitespace-pre-wrap wrap-break-word ${TONE[line.kind]}`}
                    >
                        {line.kind === "cmd" && (
                            <span className="mr-2 text-[#8FAAFF]">
                                {PROMPT}
                            </span>
                        )}
                    ...
                    >
                        ...
                        >
                            <span
                                ...
                                "
                            >
                                <span className="rounded border border-emerald-400/30 px-1.5 py-0.5 text-emerald-400">
                                    200 OK
                                </span>
                            ...
                            <span className="shrink-0 font-mono text-[9px] text-[#8A919E] sm:text-[10.5px]">
                                84 ms
                            </span>
                        </div>
                    </motion.div>
...
function Node({
    ...
    return (
        <span className="flex min-w-0 items-center gap-1.5">
            ...
            <span
                className={`truncate font-mono text-[9px] transition-colors duration-500 sm:text-[10.5px] ${
                    active
                        ? "text-[rgb(var(--ink-300))]"
                        : "text-[#343A45]"
                }`}
